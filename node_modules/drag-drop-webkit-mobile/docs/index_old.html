...
<head>
    ...
    <link rel="stylesheet" href="../release/drag-drop-polyfill.css">
    <link rel="stylesheet" href="../release/drag-drop-polyfill-icons.css">
    <link rel="stylesheet" href="../release/drag-drop-polyfill-debug.css">
    <script src="../release/drag-drop-polyfill.min.js"></script>
    <script src="../release/drag-drop-polyfill-scroll-behaviour.min.js"></script>
</head>
<body>
<section id="wrapper">
    <header>
